...
scenario as the shock scenario.
  + Default set to: `SDS`
  + Possible values: `SDS`
...
a potentially important parameter in this calculation)
  + Default set to: `0.45`
  + Possible values in the interval: `c(0.3, 0.6)`
...
of relevance in the loans calculation)
  + Default set to: `0.75`
  + Possible values in the interval: `c(0.6, 0.9)`
* `risk_free_rate` the risk free interest rate. Input parameter to the Merton
credit risk model.
  + Default set to: `0.02` 
  + Possible values in the interval: `c(0, 0.05)`
...
parameter my be relevant.
  + Default set to: `0.07`
  + Possible values in the interval: `c(-0.01, 0.1)`
...
present value should be considered to derive the equity value of a company.
  + Default set to: `1`
  + Possible values in the interval: `c(0.8, 1)`
...
production values of companies to stay in line with carbon budgets.
  + Default set to: `2030`
  + Possible values in the interval: `c(2025, 2035)` 
...
assumed to have. At this point we assume these are rolled over every year.
  + Default set to: `2`
  + Possible values in the interval: `c(1, 5)` 
* `scenario_geography` Indicates which geographical region(s) (concerning asset
location) results shall be calculated for.
  + Default set to: `"Global"`
  + Possible values: `c("Global", "AdvancedEconomies", "Africa", "AsiaPacific",` 
  `"Brazil", "CentralandSouthAmerica", "China", "DevelopingEconomies", "Eurasia",` 
  `"Europe", "EU", "India", "Japan", "MiddleEast",  "NonOECD", "NorthAmerica",` 
  `"OECD", "Russia", "SouthAfrica", "US")`
...
fallback as provided in `fallback_term`. 
