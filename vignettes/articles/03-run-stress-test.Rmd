...
the timestamp of the analysis and a suffix. The suffix is `_standard` if
stresstest is run with a fixed set of parameters. If a sensitivity analysis (see
below) is run the name of varied the detail variable is used. The subdirectory
