...
# Setting up the required folder structure for the climate transition risk stress test
...
The user needs to creat a directory that will contain all project specific files.
