---
title: "04 - Run transition risk stress test on corporate loan books"
---
...
* `use_company_terms` Logical parameter, indicating if individually provided
...
## Advanced custom data configuration

Detailed explanations of how an analysis can be configured further by
providing custom input information can be found in the vignette:
["Improve stress test by providing further project specific data"](https://2degreesinvesting.github.io/r2dii.climate.stress.test/articles/articles/05-advanced-data-settings.html).

## Interpretation of the output files

Detailed explanations of the result files can be found in the vignette:
["Understand the output files of the transition risk stress test"](https://2degreesinvesting.github.io/r2dii.climate.stress.test/articles/articles/06-read-the-outputs.html).
