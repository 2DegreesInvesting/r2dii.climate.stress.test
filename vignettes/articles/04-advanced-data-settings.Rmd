...
### Preparing company - term data The data that needs to be created is a csv
file named `company_terms.csv`. It holds the columns `company_name` (character,
holding the name of analysed companies) and term (numeric, indicates which
maturity the loans to respective companies is assumed to have in years). In
column `company_name` include all unique company names from
...
larger than 0. * `volatility`: numeric, holding volatility of asset. Needs to be
