---
title: "02 - Set up project directories for climate transition risk stress test"
---
...
3. The user has obtained all relevant input files as described in the pdf manual.
4. The user has successfully run at least the matching part of PACTA for Banks
...
* ["Run transition risk stress test"](https://2degreesinvesting.github.io/r2dii.climate.stress.test/articles/articles/04-run-stress-test.html)
