...
The material below describes in step by step how to use them:
  + r2dii.data manual: https://rmi-pacta.github.io/r2dii.data/
  + r2dii.match manual: https://rmi-pacta.github.io/r2dii.match/
  + r2dii.analysis manual: https://rmi-pacta.github.io/r2dii.analysis/
  
## Asset Resolution
The climate transition risk stress test uses forward looking asset-level production data 
