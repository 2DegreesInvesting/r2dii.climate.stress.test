...
`overview_portfolio.rda` to the indicated `data_prep_output_path`. As these data
files will serve as inputs the the subsequent stress test it is advisable to set
