...
**NOTE:** We recommend to provide the matched loan book including holdings from
all available sectors that are available in the loan book and supported in this
climate stress testing implementation. Including only a part of the loanbook
would alter results on all variables that are influenced by the entire loanbook.
