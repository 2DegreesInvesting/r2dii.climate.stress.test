...
**NOTE:** We recommend to provide the matched loan book including holdings from all
available sectors that are available in the loan book and supported in this
climate stress testing implementation. Supported sectors are:
