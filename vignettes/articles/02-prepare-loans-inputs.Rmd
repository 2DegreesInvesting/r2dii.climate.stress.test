...
The supported sectors depend on the `scenario_geography` (i.e.the geographical
region (concerning asset location) results shall be calculated for). Compare
level `Global` for the maximum number of supported sectors.
