...
```{r message=FALSE}
st_results_branch <- r2dii.climate.stress.test::run_trisk(input_path = fs::path("..", "tests","testthat","test_data","ST_INPUTS_DEV"), output_path = tempdir(), return_results = TRUE)
```
...
```{r message=FALSE}
st_results_master<- r2dii.climate.stress.test::run_trisk(input_path = fs::path("..","tests","testthat","test_data","ST_INPUTS_DEV"), output_path = tempdir(), return_results = TRUE)
```
# Compare results
