...
# main <- function() {
  # baseline_scenarios <- c("WEO2021_STEPS", "GECO2021_CurPol",
  #                         "WEO2021_APS", "NGFS2021_GCAM_CP",
  #                         "NGFS2021_GCAM_NDC", "NGFS2021_MESSAGE_CP",
  #                         "NGFS2021_MESSAGE_NDC", "NGFS2021_REMIND_CP",
  #                         "NGFS2021_REMIND_NDC", "IPR2021_baseline",
  #                         "Oxford2021_base")
  # shock_scenarios <- c("WEO2021_SDS", "WEO2021_NZE_2050",
  #                      "GECO2021_1.5C-Unif", "GECO2021_NDC-LTS",
  #                      "NGFS2021_GCAM_B2DS", "NGFS2021_GCAM_DN0",
  #                      "NGFS2021_GCAM_DT", "NGFS2021_GCAM_NZ2050",
  #                      "NGFS2021_MESSAGE_B2DS", "NGFS2021_MESSAGE_DN0",
  #                      "NGFS2021_MESSAGE_DT", "NGFS2021_MESSAGE_NZ2050",
  #                      "NGFS2021_REMIND_B2DS", "NGFS2021_REMIND_DN0",
  #                      "NGFS2021_REMIND_DT", "NGFS2021_REMIND_NZ2050",
  ...
  params_grid = list(
    ...
    #  "Delayed 2C with limited CDR (Disorderly, Rep)",
    #  "no_carbon_tax")
  ...
  multirun_trisk_mlflow(
    ...
    experiment_name = "oxford",
    trisk_input_path = "sa_st_inputs_master_raw/project_input",
    trisk_output_path = "sa_st_inputs_master_raw/project_output",
    baseline_scenarios = baseline_scenarios,
    shock_scenarios = shock_scenarios,
    params_grid = params_grid,
    save_artifacts=c("crispy_output", "company_trajectories"),
