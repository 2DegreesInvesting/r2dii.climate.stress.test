...
* Use `Sys.setenv(ST_DATA_PATH="/path/to/agnostic/data")` and `Sys.setenv(ST_PROJECT_FOLDER="/path/to/specific/data")` to configure paths to data folders.
